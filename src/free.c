...
void Free_Tree_Lk(t_tree *tree)
{
  ...
  Free(tree->alias_subpatt_rep_id_left);
  Free(tree->alias_subpatt_rep_id_rght);
  Free(tree->alias_subpatt_pair_class);
  Free(tree->alias_subpatt_pair_rep);
...
{
  Free(contmod->mu_down);
  Free(contmod->var_down);
  Free(contmod->logrem_down);

  Free(contmod->mu_up);
  Free(contmod->var_up);
  Free(contmod->logrem_up);
