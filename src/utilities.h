...
typedef struct __Tree{
  ...
  int                    *alias_subpatt_rep_id_left;
  int                    *alias_subpatt_rep_id_rght;
  int                    *alias_subpatt_pair_class;
  int                    *alias_subpatt_pair_rep;
  unsigned int            alias_subpatt_pair_capacity;
